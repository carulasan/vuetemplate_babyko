<template>
     ...
     <div class="row">
       <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="margin:auto; ">
                <q-breadcrumbs>
                    <q-breadcrumbs-el  label="Pending" icon="pending_actions" />
                    <q-breadcrumbs-el label="" />
                    
                </q-breadcrumbs>
        </div>
  </div>
         <div class="row" v-if="pending_add_not == true">
        ...
        <div class="row" style="margin-bottom : 20px;margin-top : 50px">
             ...
             <div class="col-xs-12 col-sm-12 col-md-8 col-lg-12 animate__animated animate__fadeInLeft" >
                 <q-btn color="secondary" icon="add" @click="pending_add_not = true" v-if="pending_add_not == false" outline label="New Pending"  />
                  <q-btn color="primary" icon="close" @click="pending_add_not = false" v-if="pending_add_not == true"  outline label="close"  />
             </div>
        </div>
        <div class="row">
            
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 animate__animated animate__fadeIn " style="margin:auto">
             ...
             <template v-slot:body="props">
                 <q-tr key="id" :props="props" style="cursor :pointer ;">
                        ...
                        <span>
                            ...
                            <span>
                               <q-tooltip>
                                 ...
                                 <q-btn color="red" size="sm" @click="event_cancel_order(props.row.id,props.row.customer)" style="margin-left:10px" dense icon="delete"  rounded  />
                            </span>
                           <span>
                               <q-tooltip>
...
import contentComponent from '../../components/pos_mutlple_exposure_photgraphy_services/pending/contentComponent.vue'
    ...
    this.circular_loading = true
     ...
     update_information_customer_order(update_id){
            ...
            var create_logs = {
              ...
              "description": `Pending : ${this.instance[0].first_name} update customer order information pending.`,
               }
        ...
        this.$q.dialog({
            ...
            persistent: true
                ...
                payload.pending = false
                    var create_logs = {
                 "userInstance": `${this.global_hostname}/api/user/${this.instance[0].id}/`,
              "description": `Pending : ${this.instance[0].first_name} update the pending information to set as claimed for customer name : ${payload.customer}. `,
               }
              this.actions_save_user_log(create_logs)
            ...
            event_cancel_order(id,customer){
                    ...
                    this.$q.dialog({
                        ...
                        persistent: true
                                 ...
                                 var create_logs = {
                                        "userInstance": `${this.global_hostname}/api/user/${this.instance[0].id}/`,
                                    "description": `Pending : ${this.instance[0].first_name} delete the pending information for customer name : ${customer}. `,
                                    }
                                this.actions_save_user_log(create_logs)
