    ...
    <div class="row" >
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 shadow-1" style="margin:auto; border-radius:  10px; padding:10px">
            ...
            >
             ...
             <div class="row" v-for="(item,index) in gettters_admin" :key="index" style="padding:20px; margin-bottom : 10px">
        ...
        <q-dialog v-model="dialog_admin_account" persistent>
            <q-card style="width: 100%;">
                ...
                <q-card-section>
                   <q-input style="margin-bottom : 5px" v-model="admin_account.first_name" type="text" label="First Name" />
                   <q-input style="margin-bottom : 5px" v-model="admin_account.last_name" type="text" label="Last Name" />
                   <q-input style="margin-bottom : 5px" v-model="admin_account.email" type="text" label="Email" />
                    <q-input style="margin-bottom : 5px" v-model="admin_account.username" type="text" label="Username" />
                   <q-btn-group>
...
export default {
  ...
  ...mapActions([
         ...
         event_edit_employee_information(item){
                this.admin_account = item
                this.dialog_admin_account  = true
        },
        change_password(){
          ...
          if (this.model_new_password.length <= 0) {
            ...
            data.append('employee_id' , this.admin_account.id)
         ...
         update_employee_account(){
            let data = new FormData()
            data.append('employee_id' , this.admin_account.id)
            data.append('firstname' , this.admin_account.first_name)
            data.append('lastname',this.admin_account.last_name)
            data.append('email',this.admin_account.email)
            data.append('username',this.admin_account.username)
